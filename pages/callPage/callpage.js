...
Page({
  ...
  data: {
    ...
    xingNengArr: [{ englishName: "UserLabel", chineseName: "用户友好名", meanning: "用户友好名，由EMS厂商自己指定，作为其内部标识，并可被NMS修改。" },
    ...
    resourceArr: [{ englishName: "CellLocalId", chineseName: "本地小区标识", meanning: "基站内部小区编号。" },
...
{englishName: "ReferenceSignalPower", chineseName: "参考信号功率", meanning: "小区相关的下行参考信号的发射功率（-60至50）。参见 3GPP TS 36.331。" },
    ...
    zhiBiaoArr: [{ englishName: "AdjacentCellId", chineseName: "相邻小区的标识", meanning: "指向与该小区相邻的UTRAN小区或其他系统管理的UTRAN小区的唯一标识。 (小区唯一标识表示方式为：MCC-MNC-RNCID-CID, 以上均为十进制整数，参见3GPP TS 25.401" },
